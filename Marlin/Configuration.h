...
#define STRING_CONFIG_H_AUTHOR "sider" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Sider_v1"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 83.43
  #define DEFAULT_bedKi 9.92
  #define DEFAULT_bedKd 467.68
...
#define DELTA
  ...
  #define DELTA_PRINTABLE_RADIUS 107.40    // (mm)

  // Center-to-center distance of the holes in the diagonal push rods.
  #define DELTA_DIAGONAL_ROD 300        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 340.98            // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -0.46, 0.0 , -0.15 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 117.40            // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { -0.26, 0.32, 0.06 } // Get these values from G33 auto calibrate
...
//#define ENDSTOPPULLUPS
  ...
  #define ENDSTOPPULLUP_YMAX  //ANDREW
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 393.45 }  // default steps per unit for PowerWasp
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 6000, 6000,6000, 25 }
 ...
 */
#define Z_MIN_PROBE_PIN P1_00 // Pin P0_10 or P1_00
 ...
 */
// #define RESTORE_LEVELING_AFTER_G28 //shuan
...
#define VALIDATE_HOMING_ENDSTOPS     //andrew
